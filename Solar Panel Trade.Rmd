...
plotly_fig <- plotly_fig %>% layout(title = list(text = "China vs. US: Balance Primary Value and Quantity per Year(2017-21)", font = list(size = 20)))
...
To further strengthen our previous assumption we have tentatively concluded, we 
